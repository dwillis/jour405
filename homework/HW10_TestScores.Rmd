...
Based on just looking at the score_data dataframe, have test scores improved? 


## Task 2: Calculate key statistics

Like Task 1, you will need to replace values where it says REPLACE_ME. 
...
This is where we formally test the superintendent's claim that reading scores have improved. Fill in the REPLACE_ME values
...
What does the p-value tell you, and what doesn't it tell you? How would you explain these statistical results to a non-technical audience while maintaining accuracy?
...
What metrics or outcomes beyond test scores might be important to track?
